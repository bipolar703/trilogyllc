import { CheckCircle2, Award, Users, Globe, Shield, TrendingUp, Target } from 'lucide-react';
...
const About = () => {
  ...
  const achievements = [
    { icon: <Users className="w-8 h-8" />, value: '500+', label: 'Satisfied Clients', color: 'blue' },
    { icon: <Globe className="w-8 h-8" />, value: '30+', label: 'Countries Served', color: 'green' },
    { icon: <Award className="w-8 h-8" />, value: '15+', label: 'Years Experience', color: 'purple' },
    { icon: <TrendingUp className="w-8 h-8" />, value: '98%', label: 'Success Rate', color: 'orange' }
  ];
        ...
        <div className={styles.achievementsSection}>
          <div className={styles.achievementsGrid}>
            {achievements.map((achievement, index) => (
              <div key={index} className={`${styles.achievementCard} stagger-item`}>
                <div className={`${styles.achievementIcon} ${styles[`icon${achievement.color}`]}`}>
                  {achievement.icon}
                </div>
          ...
          <div className={styles.contentGrid}>
            ...
            <div className={styles.textContent}>
              <div className={styles.contentCard}>
                ...
                <div className={styles.ctaContainer}>
                  <a href="#contact" className={`${styles.ctaButton} btn-premium`}>
            ...
            <div className={styles.cardsGrid}>
              {cards.map((card, index) => (
                <div key={card} className={`${styles.cardWrapper} stagger-item`}>
                  <GlowCard
