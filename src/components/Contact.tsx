    ...
    <div className="bg-white rounded-xl shadow-lg p-8">
      ...
      <div className="space-y-8">
        ...
        <div className="space-y-3">
          ...
          <a
            href={`tel:${t("contact.office.address.phone2")}`}
            className={`group flex items-start hover:text-brand-gold transition-colors ${
              i18n.language === "ar" ? "flex-row-reverse" : ""
            } gap-4 ml-10`}
          >
            ...
            <span
              ...
              dir="ltr"
            >
              {t("contact.office.address.phone2")}
            </span>
          </a>
        </div>
...
const Contact = ({ showOfficeInfo = true }) => {
  ...
  return (
    <section 
      id="contact" 
      className={`${showOfficeInfo ? "bg-gradient-to-br from-gray-50 to-gray-100 relative" : ""}`}
    >
      {/* Background Pattern */}
      {showOfficeInfo && (
      ...
      <div
        className={`${showOfficeInfo ? "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10" : ""}`}
      >
        {showOfficeInfo && (
          <div
        ...
        >
          ...
          {showOfficeInfo && <ContactInfo t={t} i18n={i18n} />}
        </div>
      </div>
    </section>
  );
