...
const ChatOptions: React.FC<ChatOptionsProps> = ({
  ...
  return (
    ...
    >
      <div
        className="bg-white rounded-2xl shadow-lg p-3 min-w-[240px] backdrop-blur-sm bg-opacity-95 border border-gray-100"
        data-oid="a8b-fcy"
      >
        <button
        ...
        >
          <div
            className="flex-shrink-0 w-10 h-10 bg-purple-100 rounded-full flex items-center justify-center group-hover:bg-purple-200 transition-colors"
            data-oid="idyxgnw"
          >
            <svg
          ...
          <div className="flex-1" data-oid="dmw1qva">
            <p className="font-medium text-gray-900" data-oid="2dxyrza">
              AI Assistant
            </p>
            <p className="text-sm text-gray-500" data-oid="y:5-:1j">
              Powered by Hexabot
            </p>
          </div>
        </button>
        ...
        >
          <div
            className="flex-shrink-0 w-10 h-10 bg-blue-100 rounded-full flex items-center justify-center group-hover:bg-blue-200 transition-colors"
            data-oid="ib-xltz"
          >
            <svg
          ...
          <div className="flex-1" data-oid="pjer7cs">
            <p className="font-medium text-gray-900" data-oid="vrbk6g3">
              {t("chat.liveChat")}
            </p>
            <p className="text-sm text-gray-500" data-oid="_261h0t">
              Chat with us now
            </p>
          </div>
        </button>
